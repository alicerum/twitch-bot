...
--
module Twitch.Commands.Djinn.HTypes(HKind(..), HType(..), HSymbol, hTypeToFormula, pHSymbol, pHType, pHDataType, pHTAtom, pHKind,
        prHSymbolOp,
...
import Twitch.Commands.Djinn.LJTFormula
...
ppPat _ (HPAt s p) = text s Prelude.<> text "@" Prelude.<> ppPat 10 p
